...
%>
	...
	<!-- input group -->
		...
		<section>
			<!-- 굳이 클래스 쓰지 않는다고 하더라도 부여해놓으면 좋음 -->
			<!-- 선주는 걸 border 라고 함 -->
			<article class="artist-box d-flex border border-success">
				<img width="200" class="m-2" src="<%= artistInfo.get("photo") %>" alt="아이유 프로필">
				<div class="mt-3">
					<h2 class="font-weight-bold"><%= artistInfo.get("name") %></h2>
					<h5 class="mt-2"><%= artistInfo.get("agency") %></h5>
